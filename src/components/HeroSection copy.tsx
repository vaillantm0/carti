  ...
  return (
    <main className="max-w-[1200px] mx-auto px-4">
      <section className="grid grid-cols-3 gap-5 mt-6">
        <div className="col-span-2 relative h-[500px] rounded overflow-hidden flex items-center justify-center text-center text-white bg-cover bg-center" style={{ backgroundImage: "url('')" }}>
          <div className="absolute inset-0 bg-black/20"></div>
          <div className="relative z-10">
            <h3 className="text-[32px] font-light italic">New Arrivals</h3>
            <h1 className="text-6xl my-2">Summer Sale</h1>
            <p className="text-[28px] mb-8">Minimum 50% Off</p>
            <button className="bg-transparent border-2 border-white text-white py-3 px-8 font-bold cursor-pointer transition hover:bg-white hover:text-black">
              SHOP NOW
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-gray-100 h-[240px] rounded relative overflow-hidden flex items-center p-8">
          ...
          <div className="bg-gray-100 h-[240px] rounded relative overflow-hidden flex items-center p-8">
            <div className="relative z-10 w-3/5">
              <span className="text-gray-600 text-xs font-bold">WOMEN'S FASHION</span>
